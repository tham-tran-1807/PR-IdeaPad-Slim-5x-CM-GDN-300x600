...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Slim_5x_CM_GDN_300x600_atlas_1", frames: [[0,1450,50,50],[0,0,300,600],[588,1060,266,312],[302,985,284,294],[302,0,300,600],[604,536,300,522],[0,602,300,447],[0,1051,300,397],[302,1281,245,297],[302,602,300,381],[604,0,300,534]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Slim_5x_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadSlim5xCMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(28,135);
	...
	this.instance_3.setTransform(0,77);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(150).to({_off:false},0).to({_off:true},50).wait(250));

	// Frame3
	this.instance_6 = new lib.Frame3();
	this.instance_6.setTransform(10,135);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({_off:false},0).to({_off:true},50).wait(300));

	// Frame2
	this.instance_7 = new lib.frame3160x600();
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50).to({_off:false},0).to({_off:true},50).wait(350));
...
// library properties:
lib.properties = {
	id: '44A4682887F75642A559E0BB7D8261A9',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Slim_5x_CM_GDN_300x600_atlas_1.png", id:"PR_IdeaPad_Slim_5x_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['44A4682887F75642A559E0BB7D8261A9'] = {
